<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link {{ request()->is('pengguna*') || request()->is('profile*') ? '' : 'collapsed' }}"
                data-bs-toggle="collapse" href="#pengaturan"
                aria-expanded="{{ request()->is('pengguna*') || request()->is('profile*') ? 'true' : 'false' }}">
            ...
            <div class="collapse {{ request()->is('pengguna*') || request()->is('profile*') ? 'show' : '' }}"
                id="pengaturan">
