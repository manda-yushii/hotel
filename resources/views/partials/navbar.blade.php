        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown user-dropdown">
                ...
                <a class="nav-link" href="#" data-bs-toggle="dropdown">
                    ...
                    <img class="img-xs rounded-circle" src="{{ asset('assets/images/profil.jpg') }}"
                        alt="Profile">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown">
                    ...
                    <div class="dropdown-header text-center">
                        ...
                        <img class="img-md rounded-circle mb-2" src="{{ asset('assets/images/profil.jpg') }}"
                            alt="Profile">
                    ...
                    <a class="dropdown-item text-danger" href="{{ url('/dashboard') }}"
